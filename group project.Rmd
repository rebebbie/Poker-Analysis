...
games_played_hands_1 <- games1 %>%
  ...
  summarize(
    ...
    #bankroll_diff = end_bankroll - start_bankroll
  )
...
It is clear from the preliminary data analysis that there is a notable difference between experienced players and newer players. However, our analysis is currently too limited to make any actual conclusions about how to reliably win at poker. We need some way for all of our variables to be incorporated into the final decision. To do this, we use Bayesian inference to improve on our findings and to make better use of this data. 
